...
//         <h1 className="text-3xl font-bold text-center mb-6 text-purple-900">CGPA Calculator</h1>
//         <input 
//             type="file" 
//             accept="image/*" 
//             onChange={handleFileChange} 
//             className="w-full p-3 border-none bg-purple-600 text-white rounded-lg cursor-pointer focus:outline-none"
//         />
...
//                     className="w-full mt-4 p-4 bg-purple-700 hover:bg-purple-600 rounded-lg text-lg transition"
//                 >
//                     Crop Image
//                 </button>
//             </div>
//         )}
//         {croppedImageSrc && <img src={croppedImageSrc} alt="Cropped" className="mt-5 rounded-lg w-full shadow-md" />}

//         <button 
//             onClick={handleImageUpload} 
//             disabled={loading} 
//             className="w-full mt-5 p-4 rounded-lg bg-purple-500 hover:bg-purple-400 transition font-semibold text-lg"
//         >
//             {loading ? "Processing..." : "Upload & Calculate CGPA"}
//         </button>

//         {cgpa > 0 && <h2 className="text-2xl font-semibold text-center mt-5 text-purple-900">Your CGPA: {cgpa}</h2>}
